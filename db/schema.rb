...
ActiveRecord::Schema.define(version: 2019_02_05_113655) do
  ...
  create_table "feed_contents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
